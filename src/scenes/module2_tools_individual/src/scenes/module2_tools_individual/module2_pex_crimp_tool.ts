...
export class Module2PexCrimpTool {
  ...
  private addOverlay() {
    ...
    this.overlay.innerHTML = `
      <b>PEX Crimp Tool</b><br><br>
      • Tap to activate crimp cycle<br>
      • Used for PEX copper ring connections<br>
      • Ensure ring is 1/8" from pipe end<br>
    `;
    this.container.appendChild(this.overlay);
  }

  async init() {
    await this.loadModel('/assets/models/tools/pex_crimp_tool.glb');
  }
