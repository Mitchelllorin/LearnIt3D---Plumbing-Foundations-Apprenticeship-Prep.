...
export class Module2PipeCutter {
  ...
  private addOverlay() {
    ...
    this.overlay.innerHTML = `
      <b>Pipe Cutter</b><br><br>
      • Tap to rotate the cutting wheel<br>
      • Used for clean copper cuts<br>
      • Rotate tool around pipe to slice<br>
    `;
    this.container.appendChild(this.overlay);
  }

  async init() {
    await this.loadModel('/assets/models/tools/pipe_cutter.glb');
  }
