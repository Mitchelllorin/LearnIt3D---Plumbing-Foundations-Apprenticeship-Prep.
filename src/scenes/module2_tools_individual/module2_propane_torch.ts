...
export class Module2PropaneTorch {
  ...
  private addOverlay() {
    ...
    this.overlay.innerHTML = `
      <b>Propane Torch</b><br><br>
      • Tap to ignite flame animation<br>
      • Used for soldering copper fittings<br>
      • Keep flame moving to avoid overheating<br>
    `;
    this.container.appendChild(this.overlay);
  }

  async init() {
    await this.loadModel('/assets/models/tools/propane_torch.glb');
  }
