...
export class Module2PressTool {
  ...
  private addOverlay() {
    ...
    this.overlay.innerHTML = `
      <b>Press Tool</b><br><br>
      • Tap to activate press cycle<br>
      • Used for PEX and copper press fittings<br>
      • Ensure fitting is fully seated before pressing<br>
    `;
    this.container.appendChild(this.overlay);
  }

  async init() {
    await this.loadModel('/assets/models/tools/press_tool.glb');
  }
